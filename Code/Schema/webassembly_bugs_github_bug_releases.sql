...
--
-- Table structure for table `github_bug_releases`
--

DROP TABLE IF EXISTS `github_bug_releases`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `github_bug_releases` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `RepoID` varchar(45) NOT NULL,
  `Repo` varchar(45) DEFAULT NULL,
  `RawResponse` json DEFAULT NULL,
  `ReleaseCreatedDate` text,
  `ReleasePublishedDate` text,
  `ReleaseNumber` int DEFAULT NULL,
  `IsTag` tinyint NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID`)
