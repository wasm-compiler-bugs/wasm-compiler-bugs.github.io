...
The bug dataset is constructed by scanning the repositories of six compilers, AssemblyScript, Asterius, Binaryen, Emscripten, TinyGo, and Wasm-Bindgen (obtained from <a href="https://github.com/mbasso/awesome-wasm">this list</a>), to identify issues that contained bug reports. We do this using two approaches.
